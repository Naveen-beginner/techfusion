...
const eventsData = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Replacement of team members after registration is not permitted.",
      "Participants must carry their valid college ID card, and the details must match the registration information.",
      "Participants must report 10 minutes before the scheduled event start time.",
      ...
      "All Mains Round solutions will be evaluated using predefined test cases for accuracy, logic, and robustness.",
      "The Mains Round has a duration of 2 hours."
    ],
    requirements: [
      "Valid college ID card is mandatory for all participants.",
      "Registration details must match the participant's college ID information.",
      "Each team must consist of a maximum of two participants from the same college.",
      "Participants must report at least 10 minutes before the event begins."
    ],
    teamSize: "2 Members",
  ...
  },
  {
    ...
    requirements: [
      ...
      "The submitted meme must be original and follow the specified theme and ethical guidelines.",
      "Participants must submit their Prelims entry through the official submission form before the deadline."
    ],
    teamSize: "2 Members",
